...
class EditProfileView extends StatelessWidget {
  ...
  final EditProfileViewModel vm = Get.put(EditProfileViewModel());
                        ...
                        children: [
                          ...
                          Center(
                            child: Stack(
                              children: [
                                Obx(() {
                                  final hasNewImage = vm.selectedImage.value != null;
                                  final hasCurrentImage = vm.currentProfileImageUrl.value.isNotEmpty;
                                  ...
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: hasNewImage
                                          ...
                                          : hasCurrentImage
                                              ? DecorationImage(
                                                  image: NetworkImage(vm.currentProfileImageUrl.value),
                                                  fit: BoxFit.cover,
                                                )
                                              : null,
                                    ),
